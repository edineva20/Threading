...
public class CharacterTracker extends JPanel {
    ...
    private class CharacterTrackerModel extends AbstractTableModel {
        ...
        public Object getValueAt(int row, int col) {
            switch (col) {
                case 0:
                    return Character.toString((char) charAt[row]);
                case 1:
                    return Integer.toString(counter.getCorrectNum(charAt[row]));
                case 2:
                    return Integer.toString(counter.getIncorrectNum(charAt[row]));
                default:
