 ...
 * <code>ModVector</code> can grow or shrink as needed to accommodate
 * adding and removing items after the <code>ModVector</code> has been created.<p>
 * <p>
 ...
 * Unlike the new collection implementations, ModVector is synchronized.<p>
 * <p>
 * The Iterators returned by ModVector's iterator and listIterator
 * methods are <em>fail-fast</em>: if the ModVector is structurally modified
 * at any time after the Iterator is created, in any way except through the
 * Iterator's own remove or add methods, the Iterator will throw a
 * ConcurrentModificationException.  Thus, in the face of concurrent
 * modification, the Iterator fails quickly and cleanly, rather than risking
 * arbitrary, non-deterministic behavior at an undetermined time in the future.
 * The Enumerations returned by ModVector's elements method are <em>not</em>
 * fail-fast.
 *
